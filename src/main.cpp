...
int main()
{
	...
	for(int platformIndex = 0; platformIndex < platformsCount; ++platformIndex)
	{
		...
		for(int deviceIndex = 0; deviceIndex < devicesCount; ++deviceIndex)
		{
			...
			cl_ulong globalMemSizeBytes = 0;
			OCL_SAFE_CALL(clGetDeviceInfo(device, CL_DEVICE_GLOBAL_MEM_SIZE, sizeof(globalMemSizeBytes), &globalMemSizeBytes, nullptr));
			cl_ulong globalMemSizeMB = globalMemSizeBytes / (1024 * 1024);
			std::cout << "        Global Memory: " << globalMemSizeMB << " MB" << std::endl;
